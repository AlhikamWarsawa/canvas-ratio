...
export function WeeklyReviewPage() {
  ...
  const [stories, setStories] = useState<Record<(typeof DAYS)[number], string>>({ monday: "", tuesday: "", wednesday: "", thursday: "", friday: "", saturday: "", sunday: "" });
  ...
  useEffect(() => { const saved = localStorage.getItem(`${KEY}:${weekKey}`); if (saved) setStories((current) => ({ ...current, ...JSON.parse(saved) })); setReady(true); }, [weekKey]);
